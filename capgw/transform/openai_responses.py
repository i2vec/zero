...
Vendored from polar.gateway.transform.openai_responses (import prefixes rewritten).
...
from capgw.transform.images import openai_responses_input_content_to_chat
...
class OpenAIResponsesTransformer(BaseTransformer):
    """Transform OpenAI Responses API to/from chat completions."""
    ...
    def transform_request(self, body: dict[str, Any]) -> dict[str, Any]:
        ...
        # The upstream rejects tool_choice without a non-empty tools list; bind
    ...
    def _convert_tools(self, tools: list[dict[str, Any]]) -> list[dict[str, Any]]:
        ...
        for tool in tools:
            ...
            # Drop server-side tool types we can't dispatch (web_search,
